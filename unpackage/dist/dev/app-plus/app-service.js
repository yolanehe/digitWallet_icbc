...
var render = function() {
  ...
  return _c("view", [
        ...
        _c(
          ...
          [
            ...
            _c("input", {
              ...
              attrs: { _i: 13 },
              domProps: { value: _vm._$s(13, "v-model", _vm.money) },
              on: {
                blur: _vm.onKeyInput,
    ...
    _c(
      "view",
      { staticClass: _vm._$s(15, "sc", "picker_unit"), attrs: { _i: 15 } },
      [
        _c("text", {
          staticClass: _vm._$s(16, "sc", "picker_text"),
          attrs: { _i: 16 }
        }),
        _c(
          "picker",
          {
            staticClass: _vm._$s(17, "sc", "account_picker"),
            attrs: {
              range: _vm._$s(17, "a-range", _vm.accounts),
              value: _vm._$s(17, "a-value", _vm.index),
              _i: 17
            },
            on: { change: _vm.picker_change }
          },
          [
            _c(
              "view",
              {
                staticClass: _vm._$s(18, "sc", "select_unit"),
                attrs: { _i: 18 }
              },
              [
                _c("image", {
                  ...
                  attrs: {
                    src: _vm._$s(19, "a-src", _vm.accounts[_vm.index].image),
                    _i: 19
                  }
                }),
                _c(
                  "text",
                  {
                    staticClass: _vm._$s(20, "sc", "picker_text"),
                    attrs: { _i: 20 }
                  },
                  [
                    _vm._v(
                      _vm._$s(20, "t0-0", _vm._s(_vm.accounts[_vm.index].ID))
                    )
                  ]
                )
              ]
    ...
    _c("button", {
      staticClass: _vm._$s(21, "sc", "button-style2"),
      attrs: { _i: 21 }
    })
  ])
}
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      money: '',\n      accounts: [{\n        \"image\": \"@/static/icbc.png\",\n        \"ID\": \"6212 **** 6282\" },\n      {\n        \"image\": \"@/static/ccb.png\",\n        \"ID\": \"6200 **** 3333\" },\n      {\n        \"image\": \"@/static/abc.png\",\n        \"ID\": \"4404 **** 6262\" },\n      {\n        \"image\": \"@/static/icbc.png\",\n        \"ID\": \"6277 **** 3333\" }] };\n\n\n  },\n  methods: {\n    outputcents: function outputcents(amount) {\n      amount = Math.round((amount - Math.floor(amount)) * 100);\n      return amount < 10 ? '.0' + amount : '.' + amount;\n    },\n    outputdollars: function outputdollars(number) {\n      if (number.length <= 3)\n      return number == '' ? '0' : number;else\n      {\n        var mod = number.length % 3;\n        var output = mod == 0 ? '' : number.substring(0, mod);\n\n        for (var i = 0; i < Math.floor(number.length / 3); i++) {\n          if (mod == 0 && i == 0)\n          output += number.substring(mod + 3 * i, mod + 3 * i + 3);else\n\n          output += ',' + number.substring(mod + 3 * i, mod + 3 * i + 3);\n        }\n\n        __f__(\"log\", 'outputdollars', output, \" at pages/topUpAccountWallet/topUpAccountWallet.vue:74\");\n\n        return output;\n      }\n    },\n    toThousands: function toThousands(number) {\n      number = number + \"\";\n      number = number.replace(/\\,/g, \"\");\n\n      if (isNaN(number) || number == \"\") return \"\";\n\n      number = Math.round(number * 100) / 100;\n\n      if (number < 0) {\n        return '-' + this.outputdollars(Math.floor(Math.abs(number) - 0) + '') + this.outputcents(Math.abs(number) - 0);\n      } else\n      {\n        return this.outputdollars(Math.floor(number - 0) + '') + this.outputcents(number - 0);\n      }\n\n    },\n    onKeyInput: function onKeyInput(event) {\n      if (!/^\\d+(\\.\\d{0,2})?$/.test(event.target.value)) {\n        uni.showToast({\n          title: '输入不合法' });\n\n\n        this.money = '';\n      } else\n      {\n        this.money = parseFloat(event.target.value).toFixed(2);\n      }\n    },\n    deleteMoney: function deleteMoney() {\n      this.money = '';\n    },\n    picker_change: function picker_change(event) {\n      __f__(\"log\", this.accounts, \" at pages/topUpAccountWallet/topUpAccountWallet.vue:111\");\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 7)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///33\n");
