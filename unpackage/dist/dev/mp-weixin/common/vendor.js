...
});_defineProperty(Service, "getAccounts",

function (data) {
  var url = 'digitalWallet/getCardsInfo';

  return Service.get(url, data);
});_defineProperty(Service, "walletRecharge",

function (accId, pwd, amount) {
  var url = 'digitalWallet/reCharge';
  ...
  return Service.post(url, data);
});_defineProperty(Service, "getCardInfo",

function (cardId, data) {
  var url = 'card/getCardInfo?cardId=' + cardId;

  return Service.post(url, data);
});_defineProperty(Service, "getCardInfoAndType",

function (cardId, type, data) {
  var typeCode = 1;
  if (type == '充值') {
    typeCode = 0;
  }

  var url = 'card/getCardInfo?type=' + typeCode + '&cardId=' + cardId;
  console.log(url);
  return Service.post(url, data);
});var _default =
...
BaseService = /*#__PURE__*/function () {function BaseService() {_classCallCheck(this, BaseService);}_createClass(BaseService, null, [{ key: "post", value: function post(
    url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return this.request({
        method: 'post',
        url: url,
        token: _config.default.getToken() },
      data);
...
Config = /*#__PURE__*/function () {function Config() {_classCallCheck(this, Config);}_createClass(Config, null, [{ key: "getToken", //静态配置
    ...
    {
      return bankCode;
    } }, { key: "getErrMessage", value: function getErrMessage()
    ...
    } }, { key: "getLogoMap", value: function getLogoMap()
...
NFCIdentify = /*#__PURE__*/function () {function NFCIdentify() {_classCallCheck(this, NFCIdentify);_defineProperty(this, "isWrite",
    ...
    // call listener
  }, { key: "NFCListener", value: function NFCListener() {
      // onDiscover
      NFCAdapter.onDiscovered(function (callback) {
        ...
        _service.default.getCardIdentification(aid).then(function (res) {
...
var map = {
	...
	"./failed.png": 60,
	"./icbc.png": 61,
	"./rmb_logo_black.png": 62,
	"./rmb_logo_white.png": 63,
	"./select_cards.png": 64,
	"./success.png": 65,
	"./topup_v2.png": 66,
	"./trans_v2.png": 67,
...
/* 49 */
/*!************************************************************************************!*\
  !*** /Users/yolanehe/Desktop/HbuilderApp/digitWallet_icbc/static/account_logo.png ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 54 */
/*!*********************************************************************************!*\
  !*** /Users/yolanehe/Desktop/HbuilderApp/digitWallet_icbc/static/card_logo.png ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
/* 69 */
/*!***********************************************************************************!*\
  !*** /Users/yolanehe/Desktop/HbuilderApp/digitWallet_icbc/static/wallet_logo.png ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "data:image/png;base64,"
