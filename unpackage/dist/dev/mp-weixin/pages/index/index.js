...
//
//
var _default = { data: function data() {return { display: false, imageSrc: _.default, wallet: {}, money: '***' };}, onShow: function onShow() {var _this = this; /*this.$request.request({method: 'GET', url: 'getUserInfo?id=0021002193008888'}).then(res => {
