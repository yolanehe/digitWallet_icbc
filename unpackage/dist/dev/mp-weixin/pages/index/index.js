...
var _ = _interopRequireDefault(__webpack_require__(/*! @/static/2.png */ 19));
...
//
//
var _default = { data: function data() {return { display: false, imageSrc: _.default, wallet: {}, money: '***', token: _config.default.getToken() };}, onShow: function onShow() {var _this = this;this.$request.getWallet(this.token, {}).then(function (res) {_this.wallet = res.userInfo;});}, methods: { displayDetail: function displayDetail() {var _this2 = this;this.display = !this.display;if (this.display) {this.imageSrc = __webpack_require__(/*! @/static/2.png */ 19);this.money = "***";} else {this.imageSrc = __webpack_require__(/*! @/static/1.png */ 21);this.$request.request({ method: 'GET', url: 'getUserInfo?id=0021002193008888' }).then(function (res) {_this2.money = parseFloat(_this2.wallet.amount).toFixed(2);});}}, displayImgSrc: function displayImgSrc() {return this.imageSrc;}, clipContent: function clipContent() {uni.setClipboardData({ data: this.wallet.dwId, success: function success() {uni.getClipboardData({ success: function success(res) {console.log(res.data);} });}, fail: function fail(err) {console.log('failed: ', err);} });}, navi_identifyCard: function navi_identifyCard() {console.log("navi_identifyCard");uni.navigateTo({ url: "/pages/identifyCard/identifyCard", success: function success(res) {}, fail: function fail() {}, complete: function complete() {} });
    },
